...
public:
  ...
  void AtaqueComun(bool bate) {
    if (vida - 18 > 0 && vida - 12 > 0) {
      ...
      cout << "¡TOMA! AL PERRO LE QUEDAN " << vida << " PUNTOS DE VIDA" << endl;
    } else {
      if (bate == true) {
        vida -= 18;
      } else {
      ...
      cout << "¡TOMA! EL PERRO ESTÁ MORIBUNDO" << endl;
    }
  }
  ...
  virtual void AtaqueCritico(bool bate) {
    if (vida - 18 > 0 && vida - 12 > 0) {
      ...
      cout << "¡¡¡GOLPE CRÍTICO!!! POBRE PERRO LE QUEDAN " << vida << " PUNTOS DE VIDA" << endl;
    } else {
      if (bate == true) {
        vida -= 18;
      } else {
      ...
      cout << "¡¡¡GOLPE CRÍTICO!!! EL PERRO ESTÁ MORIBUNDO" << endl;
    }
  }
